...
dataset_train_ssl = lightly.data.LightlyDataset.from_torch_dataset(torchvision.datasets.CIFAR10(
    root='/localdata/cifar10',
    train=True,
...
trainer.fit(model, dataloader_train_ssl, dataloader_test)
